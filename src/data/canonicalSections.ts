...
export const CANONICAL_SECTIONS: CanonicalSection[] = [
  ...
  { key: "infrastructure", label: "Infrastructure", short: "Infrastructure",
    aliases: ["infrastructure", "cs-infrastructure", "csd-infrastructure", "mca-infrastructure", "bca-infrastructure"] },
  ...
  { key: "industry-interface", label: "Industry Interface", short: "Industry Interface",
    aliases: ["industry-interface", "industry-interface-3", "ee-industry-interface", "civil-industry-interface", "data-science-industry-interface", "csd-industry-interface"] },
  { key: "placement", label: "Placement and Higher Studies", short: "Placements",
    aliases: ["placement", "placement-details", "placement-higher-studies", "cseds-placements", "csd-placement"] },
