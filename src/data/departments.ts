...
export const departments: Department[] = [
  ...
  make("csd", "CSD", "Computer Science & Design", "Computing foundations, product design, user experience and human-centred software systems.", noFaculty, {
    ...
    peo: [
      ...
      "Our students will be well-prepared to excel in collaborative, multidisciplinary environments, showcasing their versatility and skills.",
    ],
    pso: [
    ...
    po: [
      "PO1 – Engineering Knowledge: Apply knowledge of mathematics, natural science, computing, engineering fundamentals, and an engineering specialization (WK1–WK4) to develop solutions for complex engineering problems.",
      ...
      "PO3 – Design/Development of Solutions: Design creative solutions for complex engineering problems and develop systems, components, or processes that meet identified needs with consideration for public health and safety, whole-life cost, net-zero carbons, culture, society, and the environment.",
      "PO4 – Research: Conduct investigations of complex engineering problems using research based knowledge, including design of experiments, analysis and interpretation of data, and synthesis of information to provide valid conclusions.",
      "PO5 – Engineering Tool Usage: Create, select, and apply appropriate techniques, resources, and modern engineering and IT tools, including modelling and prediction, with an understanding of their limitations.",
      "PO6 – The Engineer and the World: Plan and evaluate societal, environmental, sustainability, health, safety, legal, and cultural impacts of engineering solutions, and integrate these considerations into engineering practice.",
      "PO7 – Ethics: Apply ethical principles and commit to professional ethics, responsibilities, inclusivity, equity, and engineering norms in professional practice.",
      "PO8 – Individual and Collaborative Team Work: Function effectively as an individual and as a member or leader in diverse, inclusive, multidisciplinary, and multicultural teams.",
      "PO9 – Communication: Communicate effectively and inclusively on complex engineering activities with the engineering community and society through reports, documentation, presentations, and the effective use of digital media.",
      "PO10 – Project Management and Finance: Apply engineering and management principles to manage projects in multidisciplinary environments, considering financial, economic, and organizational aspects.",
      "PO11 – Life-long Learning: Recognize the need for independent and life long learning and adapt to emerging technologies, changing professional practices, and societal needs.",
    ],
  ...
  make("cy", "CY", "Computer Science Engineering – Cyber Security", "Secure systems, digital forensics, ethical hacking, network security and cyber defence.", noFaculty, {
    ...
    po: [
      ...
      "PO4 – Research: Conduct investigations of complex engineering problems using research-based knowledge, including design of experiments, analysis and interpretation of data, and synthesis of information to provide valid conclusions.",
      "PO5 – Engineering Tool Usage: Create, select, and apply appropriate techniques, resources, and modern engineering and IT tools, including modelling and prediction, with an understanding of their limitations.",
      "PO6 – The Engineer and the World: Analyze and evaluate societal, environmental, sustainability, health, safety, legal, and cultural impacts of engineering solutions, and integrate these considerations into engineering practice.",
      "PO7 – Ethics: Apply ethical principles and commit to professional ethics, responsibilities, inclusivity, equity, and engineering norms in professional practice.",
      "PO8 – Individual and Collaborative Team Work: Function effectively as an individual and as a member or leader in diverse, inclusive, multidisciplinary, and multicultural teams.",
      "PO9 – Communication: Communicate effectively and inclusively on complex engineering activities with the engineering community and society through reports, documentation, presentations, and the effective use of digital media.",
      "PO10 – Project Management and Finance: Apply engineering and management principles to manage projects in multidisciplinary environments, considering financial, economic, and organizational aspects.",
