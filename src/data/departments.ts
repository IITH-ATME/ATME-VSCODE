...
const cseFaculty: Faculty[] = [
  ...
  { id: "dr-shivaprasad-b-j", name: "Dr. Shivaprasad B J", designation: "Associate Professor", qualification: "BE, M.Tech, Ph.D", doj: "06/07/2026", image: "/images/cse/dr-shivaprasad-b-j.jpg", cvUrl: "/departments/cse/faculty/dr-shivaprasad-b-j" },
  ...
  { id: "sushma-v", name: "Mrs. Sushma V", designation: "Assistant Professor", qualification: "BE, M.Tech", doj: "27-07-2015", image: "/images/uploads/2026/08/sushma-v.png", cvUrl: "https://old.atme.edu.in/mrs-sushma-v/" },
...
const dsFaculty: Faculty[] = [
  { id: "dr-anitha-d-b", name: "Dr. Anitha D B", designation: "Associate Professor", qualification: "BE,M.Tech,Ph.D", doj: "24-04-2023", image: "/images/ds/dr-anitha-d-b.jpg", cvUrl: "https://atme.edu.in/cse-data-science/cse-faculty-profile-data-science/" },
  { id: "dr-vinod-kumar-p", name: "Dr. Vinod Kumar P", designation: "Associate Professor", qualification: "BE,M.Tech,Ph.D", doj: "01-02-2013", image: "/images/ds/dr-vinod-kumar-p.jpg", cvUrl: "https://atme.edu.in/cse-data-science/cse-faculty-profile-data-science/" },
  { id: "dr-neethi-m-v", name: "Dr. Neethi M V", designation: "Assistant Professor", qualification: "BE,M.Tech,Ph.D", doj: "30-06-2023", image: "/images/ds/dr-neethi-m-v.jpg", cvUrl: "https://atme.edu.in/cse-data-science/cse-faculty-profile-data-science/" },
  { id: "mrs-madhu-nagaraj", name: "Mrs. Madhu Nagaraj", designation: "Assistant Professor", qualification: "BE,M.Tech,", doj: "30-06-2023", image: "/images/ds/mrs-madhu-nagaraj.jpg", cvUrl: "https://atme.edu.in/cse-data-science/cse-faculty-profile-data-science/" },
  { id: "mr-j-n-karthik", name: "Mr. J N Karthik", designation: "Assistant Professor", qualification: "BE,M.Tech", doj: "01-08-2025", image: "/images/ds/mr-j-n-karthik.jpg", cvUrl: "https://atme.edu.in/cse-data-science/cse-faculty-profile-data-science/" },
...
const ceFaculty: Faculty[] = [
  ...
  { id: "mrs-namitha-a-p", name: "Mrs. Namitha A P", designation: "Assistant Professor", qualification: "B.Sc,M.Sc", doj: "24.08.2020", image: "/images/uploads/2026/08/namitha-a-p.png", cvUrl: "https://atme.edu.in/civil-engineering/cv-faculty-profile/" },
...
const physicsFaculty: Faculty[] = [
  { id: "dr-mahesh-lohith-k-s", name: "Dr. Mahesh Lohith K S", designation: "Associate Professor & Head", qualification: "M.Sc, Ph.D", doj: "08/08/2016", image: "/images/physics/dr-mahesh-lohith-k-s.png", cvUrl: "https://atme.edu.in/physics/about-the-department/" },
  { id: "ramachandra-m-n", name: "Mr. Ramachandra M N", designation: "Assistant Professor", qualification: "M.Phil., M.Sc", doj: "02/09/2010", image: "/images/physics/ramachandra-m-n.jpeg", cvUrl: "https://atme.edu.in/physics/about-the-department/" },
  ...
  { id: "dr-madhusudhana-r", name: "Dr. Madhusudhana R", designation: "Assistant Professor", qualification: "B.Sc, M.Sc, M.Phil, M.Tech in Nanotechnology, Ph.D", doj: "30/08/2023", image: "/images/physics/dr-madhusudhana-r.png", cvUrl: "https://atme.edu.in/physics/about-the-department/" },
  { id: "raghavendra-r", name: "Mr. Raghavendra R", designation: "Assistant Professor", qualification: "B.Sc, M.Sc", doj: "25/08/2021", image: "/images/physics/raghavendra-r.png", cvUrl: "https://atme.edu.in/physics/about-the-department/" },
  { id: "anjan-kumar-j", name: "Mr. Anjan Kumar J", designation: "Assistant Professor", qualification: "B.Sc, M.Sc, B.Ed", doj: "27/08/2021", image: "/images/physics/anjan-kumar-j.png", cvUrl: "https://atme.edu.in/physics/about-the-department/" },
...
const chemistryFaculty: Faculty[] = [
  { id: "dr-avinash-k", name: "Dr. Avinash K", designation: "Associate Professor & Head", qualification: "B.Sc, M.Sc, Ph.D", doj: "15/07/2012", image: "/images/chemistry/dr-avinash-k.png", cvUrl: "https://atme.edu.in/chemistry/chem-about-the-department/" },
  ...
  { id: "anusha-h-s", name: "Mrs. Anusha H S", designation: "Assistant Professor", qualification: "B.Sc, M.Sc", doj: "28/08/2023", image: "/images/chemistry/anusha-h-s.jpg", cvUrl: "https://atme.edu.in/chemistry/chem-about-the-department/" },
  ...
  { id: "tejaswini-b-m", name: "Ms. Tejaswini B M", designation: "Assistant Professor", qualification: "B.Sc, M.Sc", doj: "20/02/2025", image: "/images/chemistry/tejaswini-b-m.jpg", cvUrl: "https://atme.edu.in/chemistry/chem-about-the-department/" },
...
const mathematicsFaculty: Faculty[] = [
  ...
  { id: "priyanka-n-b", name: "Mrs. Priyanka N B", designation: "Assistant Professor", qualification: "B.Sc, M.Sc", doj: "02/09/2013", image: "/images/mathematics/priyanka-n-b.png", cvUrl: "https://atme.edu.in/mathematics/about-the-department/" },
  { id: "divya-k", name: "Mrs. Divya K", designation: "Assistant Professor", qualification: "M.Sc, M.Phil", doj: "01/08/2012", image: "/images/mathematics/divya-k.jpeg", cvUrl: "https://atme.edu.in/mathematics/about-the-department/" },
  ...
  { id: "krupa-n", name: "Mrs. Krupa N", designation: "Assistant Professor", qualification: "B.Sc, M.Sc", doj: "03/10/2025", image: "/images/mathematics/krupa-n.jpg", cvUrl: "https://atme.edu.in/mathematics/about-the-department/" },
...
const humanitiesFaculty: Faculty[] = [
  ...
  { id: "bharathi-r", name: "Ms. Bharathi R", designation: "Lecturer", qualification: "MSc, MA, PGDE", doj: "15/10/2018", image: "/images/humanities/bharathi-r.jpg", cvUrl: "https://old.atme.edu.in/humanities/humanities-faculty/" },
  ...
  { id: "rakshitha-v", name: "Ms. Rakshitha V", designation: "Assistant Professor", qualification: "MA, B.Ed", doj: "16/04/2025", image: "/images/humanities/rakshitha-v.jpeg", cvUrl: "https://old.atme.edu.in/humanities/humanities-faculty/" },
  { id: "dr-muralidhar-m-p", name: "Dr. Muralidhar M P", designation: "Director of Physical Education", qualification: "Ph.D, B.A", doj: "01/08/2011", image: "/images/uploads/34980cd7-dr-muralidhar-m-p.jpg", cvUrl: "https://old.atme.edu.in/humanities/humanities-faculty/" },
];
...
const bsCommon = {
  ...
  peo: [
    "PEO1: Acquire the competence of efficiently applying the fundamental concepts and skill sets of science in engineering and technology.",
    "PEO2: Adapt to the engineering profession with communication skills, knowledge of constitution, professional ethics and environmental awareness to serve the wider community of society.",
  ],
};
...
export const departments: Department[] = [
  make("cse", "CSE", "Computer Science & Engineering", "Programming, algorithms, systems, AI, cybersecurity and full-stack engineering.", cseAllFaculty, {
    ...
    hod: { name: "Dr. Puttegowda D", designation: "Professor & Head, CSE", image: "/images/hod/puttegowda-d.png", message: "Department of Computer Science & Engineering commits to work towards developing dedicated professionals with a rich blend of competent, technical, managerial and social skills to contribute nation building. The Department with highly qualified and experienced team of faculty with industry and research background dedicates to strengthen effective teaching learning process in the ambiance of conducive environment with well supported and stuffed curricular and co-curricular activities. The Department of Computer Science & Engineering has a state of the art facility that provides the students with quality education that matches global standards and truly an academic ambiance of excellence. The Department is wide open to innovative ideas, methodologies to establish itself as the most sought excellent learning center." },
  ...
  make("aiml", "AI&ML", "Computer Science Engineering – Artificial Intelligence & Machine Learning", "Artificial intelligence, machine learning, deep learning, data-driven systems and intelligent automation.", noFaculty, {
    about: "The department of Computer Science & Engineering (Artificial Intelligence & Machine Learning) was established in the year 2021 with intake of 60 students. The Department of AIML at ATMECE is dedicated to impart constructive and quality technical education with high standards at undergraduate level.\n\nThe department focuses on building strong theoretical foundations along with practical skills in Artificial Intelligence and Machine Learning, enabling students to develop solutions to real-world and societal challenges. Supported by experienced and committed faculty, the department nurtures innovation, critical thinking, and professional competence among students.\n\nThe department is well equipped with modern computing facilities and advanced laboratories to meet current academic and industry requirements. The program strongly emphasizes experiential learning through hands-on laboratory sessions, project-based learning, research activities, and industry internships. These opportunities provide students with practical exposure and prepare them for successful global careers in emerging technologies.\n\nReflecting the department's academic excellence, two of our students secured the 3rd and 4th ranks in VTU in the academic year 2024–25.",
    hod: { name: "Dr. Anil Kumar C J", designation: "Associate Professor & Head, Computer Science Engineering – Artificial Intelligence & Machine Learning", image: "/images/hod/anil-kumar-c-j.png", message: "I am confident that the Department of Artificial Intelligence & Machine Learning at ATMECE is stalwartly prepared to face the new societal issues and challenges in this new IT era with Indian Talent (IT). At AIML we believe in teamwork — we inspire, encourage and help each other, and, most importantly, we trust each other. This is the key to our students' success. The department focuses on constructive engagements which will enable employment opportunities for our students. We hope and assure that we transform our students in all dimensions of their student life to become better citizens of this nation for a better India and a better world." },
  ...
  make("csd", "CSD", "Computer Science & Design", "Computing foundations, product design, user experience and human-centred software systems.", noFaculty, {
    about: "The Department of Computer Science and Design (CSD), established in 2021 with a sanctioned intake of 60 students, offers a future-focused undergraduate program that seamlessly blends Computer Science, Design, and Creativity to prepare students for the evolving digital world. As computing technologies continue to transform every sector, the demand for professionals who can combine technical expertise with innovative design thinking has grown significantly. The CSD program equips students with a strong foundation in computer science while fostering creativity, innovation, and user-centric problem-solving skills. The curriculum encompasses a broad spectrum of emerging domains, including Programming Languages, Software Development, Image Processing, Spatial Computing, Media Computing, Animation and Graphics, Game Design and Development, Interaction Design, User Experience (UX), and Fundamentals of Video and Photography for Engineers. The department has established a strong academic reputation by securing a University Rank in its very first graduating batch, reflecting its commitment to academic excellence and the dedication of its faculty and students. To ensure graduates are industry-ready, the department offers specialized industry-oriented training in Augmented Reality (AR) and Virtual Reality (VR), providing hands-on experience with cutting-edge technologies and real-world applications. This blend of academic rigor and practical exposure equips students with the knowledge, technical skills, and creative mindset required to excel in the rapidly evolving technology landscape.",
    vision: "To be a global leader in Computer Science and Design Engineering striving for design excellence, cultural awareness, a profound commitment to environmental stewardship, and societal responsibility.",
    mission: [
    ...
    peo: [
      "PEO1: Demonstrate the proficiency and adaptability needed to seamlessly integrate with the latest advancements and changes in Computer Science and Design.",
      "PEO2: Our graduates will possess the adaptability to explore various career paths, such as Research & Development, Manufacturing, and Entrepreneurship with independent design firms, Design Services, and Consultancies.",
      "PEO3: Our students will be well-prepared to excel in collaborative, multidisciplinary environments, showcasing their versatility and skills.",
    ],
    pso: [
    ...
    hod: { name: "Dr. Nasreen Fathima", designation: "Associate Professor & Head, CSD", image: "/images/hod/nasreen-fathima.png", message: "The department of Computer Science and Design is committed to nurturing professionals who combine strong technical knowledge with creativity, innovation, and design thinking. We provide a vibrant learning environment where students gain expertise in computer science while exploring emerging fields such as UX Design, Media Computing, Animation, Game Development, and AR/VR. Through industry-oriented training, project-based learning, and hands-on experience, we prepare students to meet the evolving demands of the technology industry. The University Rank secured by our very first graduating batch reflects our commitment to academic excellence. We encourage our students to be lifelong learners, ethical professionals, and innovative problem-solvers capable of creating meaningful technological solutions for society. I invite you to join us and be a part of this exciting journey of learning, creativity, and success." },
  }),
  make("cy", "CY", "Computer Science Engineering – Cyber Security", "Secure systems, digital forensics, ethical hacking, network security and cyber defence.", noFaculty, {
    about: "The Department of CSE-Cyber Security is committed to developing highly skilled cyber security professionals capable of protecting digital infrastructures in an increasingly connected world. Established in 2023 with a current intake of 60 students, the department offers a future-focused undergraduate program that combines strong theoretical foundations with extensive hands-on learning. The curriculum covers emerging areas such as network security, cryptography, ethical hacking, digital forensics, secure coding, and cyber threat intelligence. To enhance industry readiness, the department provides industry-oriented training in Ethical Hacking, enabling students to gain practical exposure to real-world cyber security challenges. The department has also established Memoranda of Understanding (MoUs) with reputed industries to foster industry interaction and explore internship opportunities for students. With a strong emphasis on innovation, ethics, and experiential learning, the department prepares graduates for successful careers in industry, research, entrepreneurship, and government organizations.",
    hod: { name: "Dr. Nasreen Fathima", designation: "Associate Professor & Head, CSE – Cyber Security", image: "/images/hod/nasreen-fathima.png", message: "The Department of CSE–Cyber Security is dedicated to nurturing competent, ethical, and industry-ready professionals equipped to address the evolving challenges of the digital world. Our curriculum integrates strong theoretical foundations with practical learning in cyber security, enabling students to develop expertise in securing systems, networks, and data. Through industry-oriented training in Ethical Hacking, hands-on laboratory experience, internships, and collaborations with leading organizations, students gain valuable real-world exposure. We foster innovation, critical thinking, and lifelong learning while encouraging research and professional excellence. Our goal is to empower graduates with the technical skills, ethical values, and leadership qualities required to build a secure and resilient digital future. I warmly invite you to join us and become a part of this exciting journey toward academic excellence and professional success." },
    ...
    mission: [
      "M1: To impart strong foundational knowledge in cyber security through effective teaching–learning practices and a continuously evolving curriculum that addresses emerging cyber threats and technologies.",
      "M2: To promote research, innovation, and industry collaboration in emerging areas of cyber security to address real-world digital security challenges.",
      "M3: To instill professional ethics, teamwork, leadership qualities, and a sense of social responsibility in addressing real-world cyber challenges.",
      "M4: To foster a culture of lifelong learning among students by encouraging higher studies, professional development, and active engagement with the global cyber security community.",
    ],
    peo: [
      "PEO1: Excel as cyber security professionals or entrepreneurs by applying strong fundamentals of cyber security engineering.",
      "PEO2: Pursue higher studies, research, and professional certifications while engaging in lifelong learning to keep pace with evolving cyber technologies and threats.",
      "PEO3: Exhibit leadership, teamwork, professional ethics, and social responsibility while addressing cyber security challenges in multidisciplinary environments.",
    ],
    pso: [
      "PSO1: Apply principles of computer science, programming, algorithms, operating systems, and computer networks to design and develop efficient and reliable computing solutions.",
      "PSO2: Identify, analyze, and mitigate cyber threats and vulnerabilities using techniques related to network security, ethical hacking, penetration testing, and digital forensics.",
      "PSO3: Apply cyber security policies, cyber laws, risk management practices, and incident response strategies to ensure the protection and resilience of digital systems.",
    ],
  }),
  make("ece", "ECE", "Electronics & Communication Engineering", "Signals, embedded systems, VLSI, communication and IoT.", eceAllFaculty, {
    hod: { name: "Dr. Prathiba M K", designation: "Associate Professor & HOD, ECE", image: "/images/hod/prathiba-m-k.png", message: "Electronics & Communication Department feels proud of the quality & need based instruction & Practical training imparted to its students to face the challenges of the fast changing corporate and technical world. Because of the dedicated faculty & excellent coaching in both theoretical and practical, students coming out from the portal of the ECE department are placed in top ranking companies in India & abroad, many students have gone for higher studies. In ECE department, students will study wide variety of Theoretical & Industry oriented subjects. The students will also implement their theoretical knowledge through mini & major projects which involve the innovative ideas & social relevance. It also provides a platform for the Research in the emerging areas through its research center & exhibit student co-curricular activities, paper presentation, innovative ideas, technical talents through IETE. ECE department is a right place to reach the goal and shape up the career." },
  ...
  make("eee", "EEE", "Electrical & Electronics Engineering", "Power systems, electric machines, control and renewable energy.", eeeAllFaculty, {
    ...
    hod: {
      ...
      image: "/images/hod/parthasarathy-l.png",
  ...
  make("me", "ME", "Mechanical Engineering", "Design, thermal, manufacturing and robotics.", meAllFaculty, {
    ...
    programmes: [
      { programme: "Mechanical Engineering", degree: "BE (ME)", duration: "4Yrs", intake: "30" },
    ],
    shortTermGoals: [
  ...
  make("bca", "BCA", "Bachelor of Computer Applications", "Undergraduate programme focused on computer applications, software development, databases and IT fundamentals.", noFaculty, {
    ...
    hod: { name: "Dr. Shakunthala C", designation: "Associate Professor & Head, BCA", image: "/images/hod/shakunthala-c.png", message: "Welcome to the Department of Computer Applications (BCA Programme) at ATME College of Engineering. Our mission is to nurture undergraduate students into competent, ethical and innovative computing professionals through a balanced blend of rigorous academics, hands-on lab work, interactive lectures, case studies and problem-solving sessions. We integrate the latest technologies — AI, data analytics, cloud, web and mobile application development — with strong fundamentals in software engineering and databases. Our dedicated faculty mentor students through projects, internships, industry interactions and research initiatives, while expert talks from diversified resource persons inspire them to take up entrepreneurship. We strive to develop graduates who are intellectually strong, technically competent and ready to contribute meaningfully to the dynamic and ever-evolving world of computer applications." },
    documents: {
  ...
  make("mca", "MCA", "Master of Computer Applications", "Postgraduate programme focused on application development, software engineering, databases and emerging computing technologies.", mcaAllFaculty, {
    ...
    hod: { name: "Dr. Shakunthala C", designation: "Associate Professor & Head, MCA", image: "/images/hod/shakunthala-c.png", message: "Welcome to the Department of Master of Computer Applications at ATME College of Engineering. Our mission is to nurture postgraduate students into competent, ethical and innovative computing professionals through a balanced blend of rigorous academics, hands-on lab work, interactive lectures, case studies and problem-solving sessions. We integrate the latest technologies — AI, data analytics, cloud, web and mobile application development — with strong fundamentals in software engineering and databases. Our dedicated faculty mentor students through projects, internships, industry interactions and research initiatives, while expert talks from diversified resource persons inspire them to take up entrepreneurship. We strive to develop graduates who are intellectually strong, technically competent and ready to contribute meaningfully to the dynamic and ever-evolving world of computer applications." },
    // No dept-specific Vision/Mission/PEOs/PSOs exist on old.atme.edu.in for
  ...
  make("mba", "MBA", "Master of Business Administration", "Postgraduate management programme covering finance, marketing, human resources, operations and entrepreneurship.", noFaculty, {
    ...
    hod: {
      ...
      image: "/images/hod/oscar-abhishek.png",
